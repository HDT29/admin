...
<head>
    ...
    <link href="{{asset('food/public/backend/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{asset('food/public/backend/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('food/public/backend/css/datepicker3.css')}}" rel="stylesheet">
    <link href="{{asset('food/public/backend/css/styles.css')}}"rel="stylesheet">

    <!--Custom Font-->
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
    <!--[if lt IE 9]>
    <script src="{{asset('food/public/backend/js/html5shiv.js')}}"></script>
    <script src="{{asset('food/public/backend/js/respond.min.js')}}"></script>
    <![endif]-->
</head>
<body>
...
<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <div class="profile-sidebar">
        <div class="profile-userpic">
            <img src="{{('food/public/backend/images/3.png')}}" class="img-responsive" alt="">
        </div>
...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Chào mừng đến trang quản trị</h1>
        </div>
    </div><!--/.row-->
...
<script src="{{asset('food/public/backend/js/jquery-1.11.1.min.js')}}"></script>
<script src="{{asset('food/public/backend/js/bootstrap.min.js')}}"></script>
<script src="{{asset('food/public/backend/js/chart.min.js')}}"></script>
<script src="{{asset('food/public/backend/js/chart-data.js')}}"></script>
<script src="{{asset('food/public/backend/js/easypiechart.js')}}"></script>
<script src="{{asset('food/public/backend/js/easypiechart-data.js')}}"></script>
<script src="{{asset('food/public/backend/js/bootstrap-datepicker.js')}}"></script>
<script src="{{asset('food/public/backend/js/custom.js')}}"></script>
<script>
